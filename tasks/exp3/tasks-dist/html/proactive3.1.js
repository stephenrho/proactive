...
function prac_wm_search_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPrac_wm_search_loop of prac_wm_search_loop) {
...
function wm_search_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisWm_search_loop of wm_search_loop) {
...
function search_missRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of search_missComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
