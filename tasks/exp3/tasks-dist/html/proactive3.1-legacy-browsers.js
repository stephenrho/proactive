...
let expName = 'proactive3.1';  // from the Builder filename that created this script
...
function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=4F32FF94', '');
...
function experimentInit() {
  ...
  text_14 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_14',
    text: 'Well done!\n\nNow we will practice both tasks together. Remember, you will see 4 image-word pairs to remember. Then during the 10 second interval you will have 4 search problems to respond to (is the target square open on the left or right?). After that you will be asked to type the word associated with each image you studied.\n\nThere will be 3 example sequences to practice the tasks together.\n\nPress SPACE to continue.',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.1,  wrapWidth: 1.6, ori: 0,
    color: new util.Color('black'),  opacity: 1,
  ...
  search_missClock = new util.Clock();
...
function learn_instr1RoutineBegin(trials) {
  return function () {
    ...
    learn_instr1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_instr2RoutineBegin(trials) {
  return function () {
    ...
    learn_instr2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_instr3RoutineBegin(trials) {
  return function () {
    ...
    learn_instr3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_instr4RoutineBegin(trials) {
  return function () {
    ...
    learn_instr4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function example_recallLoopBegin(thisScheduler) {
  ...
  example_recall.forEach(function() {
...
function prac_learn_study_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  prac_learn_study_loop.forEach(function() {
...
function prac_learn_test_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  prac_learn_test_loop.forEach(function() {
...
function learn_blocks_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  learn_blocks_loop.forEach(function() {
...
function learn_study_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  learn_study_loop.forEach(function() {
...
function learn_test_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  learn_test_loop.forEach(function() {
...
function final_learn_testLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  final_learn_test.forEach(function() {
...
function prac_wm_trial_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  prac_wm_trial_loop.forEach(function() {
    ...
    const prac_wm_search_loopLoopScheduler = new Scheduler(psychoJS);
    thisScheduler.add(prac_wm_search_loopLoopBegin, prac_wm_search_loopLoopScheduler);
    thisScheduler.add(prac_wm_search_loopLoopScheduler);
    thisScheduler.add(prac_wm_search_loopLoopEnd);
...
var prac_wm_search_loop;
function prac_wm_search_loopLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  prac_wm_search_loop = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 4, method: TrialHandler.Method.SEQUENTIAL,
    extraInfo: expInfo, originPath: undefined,
    trialList: undefined,
    seed: undefined, name: 'prac_wm_search_loop'
  });
  psychoJS.experiment.addLoop(prac_wm_search_loop); // add the loop to the experiment
  currentLoop = prac_wm_search_loop;  // we're now the current loop

  // Schedule all the trials in the trialList:
  prac_wm_search_loop.forEach(function() {
    const snapshot = prac_wm_search_loop.getSnapshot();
    ...
    thisScheduler.add(searchRoutineEachFrame(snapshot));
    thisScheduler.add(searchRoutineEnd(snapshot));
    thisScheduler.add(search_missRoutineBegin(snapshot));
    thisScheduler.add(search_missRoutineEachFrame(snapshot));
    thisScheduler.add(search_missRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  });
...
function prac_wm_search_loopLoopEnd() {
  psychoJS.experiment.removeLoop(prac_wm_search_loop);
...
function prac_wm_test_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  prac_wm_test_loop.forEach(function() {
...
function wm_trial_loopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  wm_trial_loop.forEach(function() {
    ...
    thisScheduler.add(wm_studyRoutineEachFrame(snapshot));
    thisScheduler.add(wm_studyRoutineEnd(snapshot));
    const wm_search_loopLoopScheduler = new Scheduler(psychoJS);
    thisScheduler.add(wm_search_loopLoopBegin, wm_search_loopLoopScheduler);
    thisScheduler.add(wm_search_loopLoopScheduler);
    thisScheduler.add(wm_search_loopLoopEnd);
...
var wm_search_loop;
function wm_search_loopLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  wm_search_loop = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 4, method: TrialHandler.Method.SEQUENTIAL,
    extraInfo: expInfo, originPath: undefined,
    trialList: undefined,
    seed: undefined, name: 'wm_search_loop'
  });
  psychoJS.experiment.addLoop(wm_search_loop); // add the loop to the experiment
  currentLoop = wm_search_loop;  // we're now the current loop

  // Schedule all the trials in the trialList:
  wm_search_loop.forEach(function() {
    const snapshot = wm_search_loop.getSnapshot();
...
function wm_search_loopLoopEnd() {
  psychoJS.experiment.removeLoop(wm_search_loop);
...
function learn_testRoutineBegin(trials) {
  return function () {
    ...
    learn_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_feedbackRoutineBegin(trials) {
  return function () {
    ...
    learn_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_instr5RoutineBegin(trials) {
  return function () {
    ...
    learn_instr5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_studyRoutineBegin(trials) {
  return function () {
    ...
    learn_studyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_test_instrRoutineBegin(trials) {
  return function () {
    ...
    learn_test_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_end_pracRoutineBegin(trials) {
  return function () {
    ...
    learn_end_pracComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function set_counterRoutineBegin(trials) {
  return function () {
    ...
    set_counterComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function begin_blockRoutineBegin(trials) {
  return function () {
    ...
    begin_blockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function next_instrRoutineBegin(trials) {
  return function () {
    ...
    next_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function break_learnRoutineBegin(trials) {
  return function () {
    ...
    break_learnComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function learn_final_instrRoutineBegin(trials) {
  return function () {
    ...
    learn_final_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function end_learnRoutineBegin(trials) {
  return function () {
    ...
    end_learnComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function wm_instrRoutineBegin(trials) {
  return function () {
    ...
    wm_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function wm_instr2RoutineBegin(trials) {
  return function () {
    ...
    wm_instr2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_instrRoutineBegin(trials) {
  return function () {
    ...
    search_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_instr2RoutineBegin(trials) {
  return function () {
    ...
    search_instr2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_instr3RoutineBegin(trials) {
  return function () {
    ...
    search_instr3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_isiRoutineBegin(trials) {
  return function () {
    ...
    search_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function wm_instr3RoutineBegin(trials) {
  return function () {
    ...
    wm_instr3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function STRoutineBegin(trials) {
  return function () {
    ...
    STComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function wm_studyRoutineBegin(trials) {
  return function () {
    ...
    wm_studyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
var search_missComponents;
function search_missRoutineBegin(trials) {
  return function () {
    //------Prepare to start Routine 'search_miss'-------
    t = 0;
    search_missClock.reset(); // clock
    frameN = -1;
    // update component parameters for each repeat
    if ( !(search_resp.keys in ["0", "1"]) ){
        miss_count++;
    }
    // keep track of which components have finished
    search_missComponents = [];
    
    search_missComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_missRoutineEachFrame(trials) {
  return function () {
    //------Loop for each frame of Routine 'search_miss'-------
    let continueRoutine = true; // until we're told otherwise
    // get current time
...
function search_missRoutineEnd(trials) {
  return function () {
...
function wm_testRoutineBegin(trials) {
  return function () {
    ...
    wm_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function wm_recall_isiRoutineBegin(trials) {
  return function () {
    ...
    wm_recall_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function writeRoutineBegin(trials) {
  return function () {
    ...
    writeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function search_reminderRoutineBegin(trials) {
  return function () {
    ...
    search_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function end_wm_pracRoutineBegin(trials) {
  return function () {
    ...
    end_wm_pracComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
