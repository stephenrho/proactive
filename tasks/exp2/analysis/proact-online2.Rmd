---
title: "Proactive online - Experiment 2"
output:
...
if (wr){
  ...
  write.csv(x = wm_dat, file = "exp2_wm.csv", row.names = F)
  write.csv(x = learn_dat, file = "exp2_learn.csv", row.names = F)
  write.csv(x = search_dat, file = "exp2_search.csv", row.names = F)
}
