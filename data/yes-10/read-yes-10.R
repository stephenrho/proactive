...
# read data from the 10 s interval, with distraction condition
...
# write data to csv
write.csv(x = search_dat, file = "yes10_search.csv", row.names = F)
write.csv(x = wm_dat, file = "yes10_wm.csv", row.names = F)
write.csv(x = learn_dat, file = "yes10_learn.csv", row.names = F)
